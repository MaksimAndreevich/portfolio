...
const cards: Array<IProjectCard> = [
  {
    title: "TODO",
    image: <Image src="/images/projects/todo.png" width={345} height={140} alt="Screenshots of todo project" />,
    description:
  ...
  {
    title: "Weather",
    image: <Image src="/images/projects/weather.png" width={345} height={140} alt="Screenshots of todo project" />,
    description:
